        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.headingContainer}>
                    ...
                    <View style={{flexDirection: 'row', flexWrap: 'wrap'}}>
                        <Text style={styles.subheading1}>Try Out Our</Text><Text style={styles.subheading2}>Cool Filters</Text>
                    </View>
                </View>
                <View style={styles.contentContainer}>
                    <View style={{flex: 0.5}}>
                        <Text style={styles.contentText}>Enjoy our funny filters!</Text>
                    </View>
